...
@TeleOp
public class Tele_AutoEnterScoringMode_RobotCentric_TriggerTurn_StickUpHirghtChange extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if(gamepad1.right_stick_button && gamepad1.left_stick_button) {
                ...
                if(currentGamepad1.left_bumper && !previousGamepad1.left_bumper  && CurrentSlideState == SlideState.RETRACTED && CurrentMiniArmState == MiniArmState.HOVERING){
                    CurrentMiniArmState = MiniArmState.Intaking;
                }else if(currentGamepad1.left_bumper && !previousGamepad1.left_bumper && (CurrentMiniArmState == MiniArmState.Intaking|| CurrentMiniArmState == MiniArmState.Scoringhigh|| CurrentMiniArmState == MiniArmState.ScoringLow)){
                    CurrentMiniArmState = MiniArmState.HOVERING;
                }else if(CurrentSlideState == SlideState.EXTEND1 && CurrentMiniArmState != MiniArmState.ScoringLow){
                    CurrentMiniArmState = MiniArmState.ScoringLow;
                }else if(CurrentSlideState == SlideState.EXTEND2 && CurrentMiniArmState != MiniArmState.ScoringLow){
                    CurrentMiniArmState = MiniArmState.ScoringLow;
                }else if(CurrentSlideState == SlideState.EXTEND3 && CurrentMiniArmState != MiniArmState.ScoringLow){
                    CurrentMiniArmState = MiniArmState.ScoringLow;
                }else if(CurrentSlideState == SlideState.EXTEND4 && CurrentMiniArmState != MiniArmState.ScoringLow){
                    CurrentMiniArmState = MiniArmState.ScoringLow;
                }else if(CurrentSlideState == SlideState.EXTEND5 && CurrentMiniArmState != MiniArmState.Scoringhigh){
                    CurrentMiniArmState = MiniArmState.Scoringhigh;
                }else if(CurrentSlideState == SlideState.MAXEXTEND && CurrentMiniArmState != MiniArmState.Scoringhigh){
                    CurrentMiniArmState = MiniArmState.Scoringhigh;
                }
                /*
